...
dat_2024 = readRDS(file = "data/dat_2024_macros.rds") %>% rename(sample_id = macro_id)
...
saveRDS(dat_2024_clauset_xmins, file = "data/dat_macros_2024_clauset.rds")
saveRDS(dat_2024_clauset_xmins %>% filter(year <= 2022), 
        file = "data/dat_macros_2022_clauset.rds")
saveRDS(dat_2024_clauset_xmins %>% filter(year >= 2022), 
        file = "data/dat_macros_20232024_clauset.rds")
