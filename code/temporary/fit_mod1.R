...
# This is the code used to fit models on USD's Lawrence Cluster on 9/21/2024
...
dat_sumnorm = readRDS("data/derived_data/dat_sumnorm.rds") %>% 
  group_by(sample_id) %>% 
  mutate(xmin = min(dw),
         xmax = max(dw))
...
saveRDS(fit_temp_om_gpp_newxmin_sumnorm, file = "models/fit_temp_om_gpp_newxmin_sumnorm.rds")
...
#                                       iter = 2000)
# 
# saveRDS(fit_temp_gpp_newxmin_sumnorm, file = "models/fit_temp_gpp_newxmin_sumnorm.rds")
# 
# # 3) om*gpp
...
#                                     iter = 2000)
# 
# saveRDS(fit_om_gpp_newxmin_sumnorm, file = "models/fit_om_gpp_newxmin_sumnorm.rds")
# 
# # 4) om*temp
...
#                                      iter = 2000)
# 
# saveRDS(fit_om_temp_newxmin_sumnorm, file = "models/fit_om_temp_newxmin_sumnorm.rds")
# 
# # 5) om
...
#                                 iter = 2000)
# 
# saveRDS(fit_om_newxmin_sumnorm, file = "models/fit_om_newxmin_sumnorm.rds")
# 
# # 6) gpp
...
#                                  iter = 2000)
# 
# saveRDS(fit_gpp_newxmin_sumnorm, file = "models/fit_gpp_newxmin_sumnorm.rds")
# 
# # 7) temp
...
#                                   iter = 2000)
# 
# saveRDS(fit_temp_newxmin_sumnorm, file = "models/fit_temp_newxmin_sumnorm.rds")
